  ...
  static show(
    ...
    return showGeneralDialog(
        ...
        pageBuilder: (BuildContext buildContext, Animation<double> animation,
          ...
          return ArtDialog(key: artDialogKey ?? null, artDialogArgs: artDialogArgs);
        },
        ...
        transitionBuilder: (BuildContext context, Animation<double> animation,
          ...
          return ScaleTransition(
              ...
              scale: CurvedAnimation(
                  parent: animation, curve: Interval(0.00, 1.0, curve: Curves.easeInOutBack)),
              child: FadeTransition(
                  opacity: CurvedAnimation(parent: animation, curve: Curves.linear), child: child));
        },
